...
1. Read `README.md`, `ARCHITECTURE.md`, and `marge-simpson/system/workflows/_index.md` to understand the project's purpose
2. Skim existing `marge-simpson/system/tracking/` to avoid duplicating planned work
...
Create or update: `marge-simpson/system/tracking/recommended_features.md`
...
- If a feature overlaps with something in `marge-simpson/system/tracking/tasklist.md`, note the overlap rather than re-proposing
