...
**Scope (CRITICAL):**
1. The `.marge/` folder is **excluded from audits** — it is the tooling, not the target, unless `meta_marge/` exists and is being used to update Marge.
...
Pricing in `.marge/model_pricing.json`.
