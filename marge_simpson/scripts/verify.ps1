...
Usage:
  powershell -ExecutionPolicy Bypass -File .\.marge\scripts\verify.ps1 fast
  powershell -ExecutionPolicy Bypass -File .\.marge\scripts\verify.ps1 full
  powershell -ExecutionPolicy Bypass -File .\.marge\scripts\verify.ps1 fast -SkipIfNoTests
