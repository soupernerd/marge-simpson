...
## Tracking (required)
- **Next ID:** MS-0001
  - Use this for the next new Issue/Task ID, then increment here AND in `tracking/assessment.md`.
...
- [ ] **MS-0001 —** (clear, testable outcome)
  ...
  - **Verification:**
    ...
    - Record evidence in `./tracking/assessment.md` (raw output or verify log path).
