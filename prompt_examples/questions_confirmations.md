...
After finished above, search for and list remaining unchecked items (if any exist) in marge-simpson/planning_docs/tasklist.md (P0 → P1 → P2). Suggest order of operations.
